...
public class EditContact extends baseClass{
	...
	public void EditContactTest(String titleValue, String birthDay, String phoneNumber) throws InterruptedException {
		...
		for (String name : sets) {
			...
			WebElement phoneNumberBox=driver.findElement(By.xpath("//label[text()='Phone']//following::input[@name='Phone']"));
