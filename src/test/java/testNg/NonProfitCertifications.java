...
public class NonProfitCertifications extends baseClass{
	...
	@Test()
	public void NonProfitCertificationsTest() throws InterruptedException {
		...
		WebElement systemStatus=driver.findElement(By.
				xpath("//span[text()='See System Status']//ancestor::div[@class='tileHelp']//div[@class='tileNavButton']/button"
						)); 
